...
$PAGE->set_title('Site Search Analytics');
$PAGE->set_url('/local/analytics/reports/search.php', $urlparams); // Defined here to avoid notices on errors etc
...
$report = getSearchReport($startdate, $enddate);
    ...
    <section class="content-header">
        ...
        <script type="text/javascript">
            ...
            $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
                ...
                window.location.href = "search.php"+param;
            });
        </script>
    </section>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php echo $report->stats->totalsearch; ?></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Total Unique Searches</span>
                        <span class="info-box-number"><?php echo $report->stats->uniquesearch; ?></span>
                    </div><!-- /.info-box-content -->
                </div><!-- /.info-box -->
            </div><!-- /.col -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php echo $report->stats->periodsearch; ?></span>
                    </div><!-- /.info-box-content -->
                </div><!-- /.info-box -->
            </div><!-- /.col -->
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Unique Searches</span>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Searches from - <?php echo $rptdate; ?></h3>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Search Kewords</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
