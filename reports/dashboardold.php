...
if ($courseid > 1) {
    $PAGE->set_title($COURSE->fullname . ' / Analytics Dashboard');
} else {
    $PAGE->set_title('Site Analytics Dashboard');
}
...
$report = getLandingReport($startdate, $enddate , $courseid);
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="progress-group">
                                    ...
                                    <div class="progress sm">
                                        <div class="progress-bar progress-bar-aqua" style="width: <?php echo safediv($report->stats->uniquevisitor, $report->stats->totalvisit) * 100; ?>%"></div>
                                    </div>
                                </div><!-- /.progress-group -->
                                <div class="progress-group">
                                    ...
                                    <div class="progress sm">
                                        <div class="progress-bar progress-bar-yellow" style="width: <?php echo safediv($report->stats->totalrepeatvisit, $report->stats->totalvisit) * 100; ?>%"></div>
                                    </div>
                                </div><!-- /.progress-group -->
                                <div class="progress-group">
                                    ...
                                    <div class="progress sm">
                                        <div class="progress-bar progress-bar-yellow" style="width: <?php echo safediv3($report->stats->totalactions, $report->stats->totalvisit, $report->stats->maxactions) * 100; ?>%"></div>
                                    </div>
                                </div><!-- /.progress-group -->
                                <div class="progress-group">
                                    ...
                                    <div class="progress sm">
                                        <div class="progress-bar progress-bar-red" style="width: <?php echo safediv3($report->stats->totaltime, $report->stats->totalactions, $report->stats->maxtime) * 100; ?>%"></div>
                                    </div>
                                </div><!-- /.progress-group -->
                                <!--
                                <div class="progress-group">
