...
class Piwik
{
    ...
    {
        if (CacheHelper::hasKey('AllSuperUserAccessEmailAddresses'))
            return CacheHelper::getValue('AllSuperUserAccessEmailAddresses');
        $emails = array();
        ...
        CacheHelper::setValue('AllSuperUserAccessEmailAddresses', $emails);
        return $emails;
    }
