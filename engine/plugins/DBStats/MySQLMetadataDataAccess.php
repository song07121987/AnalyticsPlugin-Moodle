...
class MySQLMetadataDataAccess
{
    ...
    public function getColumnsFromTable($tableName)
    {
        if (QueryHelper::DEFAULT_SCHEMA == 'Mssql') {
            return Db::fetchAll("SELECT column_name as Field, data_type as [Type], is_nullable as [Null], '' as [Key],  column_default  as [Default], '' as Extra FROM INFORMATION_SCHEMA.COLUMNS
